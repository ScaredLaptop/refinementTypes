...
(define-extended-language TypedLambda/Inference Constraints
  ...
  [r ::= {HOLE x} {v : p}] ; refinements i.e. {v: 0 < v}
  [t s ::= 
...
(define-judgment-form
  ...
  [
    (hole-instantiation s t) (wf-type Γ t k) (check-type Γ e t)
    --------------------- "SYN-ANN"
...
(define-judgment-form
  ...
  [
    (hole-instantiation s_1 t_1) (wf-type Γ t_1 k) (check-type (extend Γ x t_1) e_1 t_1) (check-type (extend Γ x t_1) e_2 t_2)
    --------------------- "CHK-REC"
